	...
	public class ObjectDefinitionFactoryPostProcessor extends AbstractOrderedFactoryPostProcessor {
		...
		public function mergeCustomConfigurators(sourceDefinition:IObjectDefinition, destinationDefinition:IObjectDefinition):void {
			if (sourceDefinition.customConfiguration != null) {
				var configurators:Vector.<ICustomConfigurator>;
				if (sourceDefinition.customConfiguration is Vector.<ICustomConfigurator>) {
					configurators = sourceDefinition.customConfiguration;
				} else if (sourceDefinition.customConfiguration is ICustomConfigurator) {
					configurators = new Vector.<ICustomConfigurator>();
					configurators[configurators.length] = (sourceDefinition.customConfiguration as ICustomConfigurator);
				}
				if (configurators != null) {
					if (destinationDefinition.customConfiguration != null) {
						var otherConfigurators:Vector.<ICustomConfigurator>;
						if (destinationDefinition.customConfiguration is Vector.<ICustomConfigurator>) {
							...
							otherConfigurators = new Vector.<ICustomConfigurator>();
							otherConfigurators[otherConfigurators.length] = (destinationDefinition.customConfiguration as ICustomConfigurator);
						}
						if (otherConfigurators != null) {
							for each (var config:ICustomConfigurator in configurators) {
